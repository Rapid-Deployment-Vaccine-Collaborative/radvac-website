...
export const STUDIES: Study[] = [
  { pathogen: "SARS-CoV-2", model: "mice", yeast: "P. pastoris", prep: "killed", antigen: { abbr: "FliC–RBD–foldon", full: "Spike receptor-binding domain fused to the T4 fibritin foldon trimerization domain and a truncated Salmonella typhimurium flagellin (FliC) peptide as a built-in adjuvant, anchored to the cell wall by SED1" }, location: "surface", response: { short: "serum IgG · fecal IgA", detail: "RBD-specific serum IgG and fecal IgA both significantly raised (p<0.0001). The trimerized, flagellin-bearing construct was strongest; the plain RBD construct gave only modest IgA and was less effective than the non-recombinant yeast control at the higher dose. ELISAs ran on sera and fecal extracts pooled across the five mice per group, so the triplicate measures assay rather than biological variation. No neutralization assay, cytokines or virus challenge." }, cite: "Saveii 2026", url: "https://doi.org/10.1038/s41598-026-50942-z" },
